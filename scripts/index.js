...
const nameInput = profileForm.querySelector(".popup__form_profile_field_type_name");
const jobInput = profileForm.querySelector(".popup__form_profile_field_type_prof");
...
const newCardNameInput = newCardForm.querySelector(".popup__form_new-card_field_type_name");
const newCardSrcInput = newCardForm.querySelector(".popup__form_new-card_field_type_src");
