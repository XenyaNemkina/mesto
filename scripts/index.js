...
const nameInput = profileForm.querySelector(".popup__field_type_name_profile");
const jobInput = profileForm.querySelector(".popup__field_type_prof_profile");
...
const newCardNameInput = newCardForm.querySelector(".popup__field_type_name_new-card");
const newCardSrcInput = newCardForm.querySelector(".popup__field_type_src_new-card");
