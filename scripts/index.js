const profilePopup = document.querySelector(".popup__profile"); /* переменная 1 */
const profileCloseButton = profilePopup.querySelector(".popup__profile_close"); /* кнопка закрытия 1 */
const profileOpenButton = document.querySelector(".info__button"); /* кнопка открытия 1 */
const profileSaveButton = document.querySelector(".popup__profile_save");
const elementsContainer = document.querySelector(".elements");
const cardTemplate = document.querySelector("#element-template").content.querySelector(".element");
const newCardPopup = document.querySelector(".popup__new-card"); /* переменная 2 */
const newCardCloseButton = newCardPopup.querySelector(".popup__new-card_close"); /* кнопка закрытия 2 */
const newCardOpenButton = document.querySelector(".profile__add-button"); /* кнопка открытия 2 */
const newCardSaveButton = newCardPopup.querySelector(".popup__new-card_save");
const fullImgPopup = document.querySelector(".popup__full-image"); /* переменная 3 */
const fullImgCloseButton = fullImgPopup.querySelector(".popup__full-image_close"); /* кнопка закрытия 3 */
const profileForm = document.querySelector(".popup__profile_form");
const nameInput = profileForm.querySelector(".popup__field_type_name");
...
const newCardForm = document.querySelector(".popup__new-card_form");
const newCardNameInput = newCardForm.querySelector(".popup__new-card_form_field_type_name");
const newCardSrcInput = newCardForm.querySelector(".popup__new-card_form_field_type_src");
const fullImgElement = document.querySelector(".popup__full-image_img");
const fullImgName = document.querySelector(".popup__full-image_name");
